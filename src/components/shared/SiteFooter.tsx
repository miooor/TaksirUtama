...
export function SiteFooter({ school }: { school: SchoolPublicProfile }) {
  return (
    <footer className="mx-auto mt-8 flex max-w-7xl flex-wrap items-center gap-2 border-t border-border-default px-4 py-5 text-sm text-text-muted sm:px-6 lg:px-8">
